...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.bg='';//background (Mr. Amorins and such)
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='log')
			{
				...
				'<div class="listing">-each Mr. Amorin upgrade now requires 15 of the matching building</div>'+
				...
				'<div class="listing">-added a way to permanently stop the Mr. Amorinpocalypse</div>'+
				'<div class="listing">-Elder Pledge price is now capped</div>'+
				'<div class="listing">-One Mind and other Mr. Amorin research upgrades are now a little more powerful, if not 100% accurate</div>'+
				'<div class="listing">-"golden" cookie now appears again during Mr. Amorinpocalypse; Elder Pledge-related achievements are now unlockable</div>'+
				
				'</div><div class="subsection update">'+
				'<div class="title">31/08/2013 - too many Mr. Amorins</div>'+
				'<div class="listing">-the Mr. Amorinpocalypse is back, along with more Mr. Amorin types</div>'+
			...
			else if (Game.onMenu=='stats')
			{
				...
				(wrathStr!=''?'<div class="listing"><b>Mr. Amorintriarchs status :</b> '+wrathStr+'</div>':'')+
		...
		Game.getNewTicker=function()
		{
			...
			{				
				if (Game.Objects['Mr. Amorin'].amount>0) list.push(choose([
				'<q>Moist cookies.</q><sig>Mr. Amorin</sig>',
				'<q>We\'re nice Mr. Amorins.</q><sig>Mr. Amorin</sig>',
				'<q>Indentured servitude.</q><sig>Mr. Amorin</sig>',
				'<q>Come give Mr. Amorin a kiss.</q><sig>Mr. Amorin</sig>',
				'<q>Why don\'t you visit more often?</q><sig>Mr. Amorin</sig>',
				'<q>Call me...</q><sig>Mr. Amorin</sig>'
				]));
				
				if (Game.Objects['Mr. Amorin'].amount>=50) list.push(choose([
				'<q>Absolutely disgusting.</q><sig>Mr. Amorin</sig>',
				'<q>You make me sick.</q><sig>Mr. Amorin</sig>',
				'<q>You disgust me.</q><sig>Mr. Amorin</sig>',
				'<q>We rise.</q><sig>Mr. Amorin</sig>',
				'<q>It begins.</q><sig>Mr. Amorin</sig>',
				'<q>It\'ll all be over soon.</q><sig>Mr. Amorin</sig>',
				'<q>You could have stopped it.</q><sig>Mr. Amorin</sig>'
				]));
				
				if (Game.HasAchiev('Just wrong')) list.push(choose([
				'News : cookie manufacturer downsizes, sells own grandmother!',
				'<q>It has betrayed us, the filthy little thing.</q><sig>Mr. Amorin</sig>',
				'<q>It tried to get rid of us, the nasty little thing.</q><sig>Mr. Amorin</sig>',
				'<q>It thought we would go away by selling us. How quaint.</q><sig>Mr. Amorin</sig>',
				'<q>I can smell your rotten cookies.</q><sig>Mr. Amorin</sig>'
				]));
				
				if (Game.Objects['Mr. Amorin'].amount>=1 && Game.pledges>0 && Game.elderWrath==0) list.push(choose([
				'<q>shrivel</q><sig>Mr. Amorin</sig>',
				'<q>writhe</q><sig>Mr. Amorin</sig>',
				'<q>throb</q><sig>Mr. Amorin</sig>',
				'<q>gnaw</q><sig>Mr. Amorin</sig>',
				'<q>We will rise again.</q><sig>Mr. Amorin</sig>',
				'<q>A mere setback.</q><sig>Mr. Amorin</sig>',
				'<q>We are not satiated.</q><sig>Mr. Amorin</sig>',
				'<q>Too late.</q><sig>Mr. Amorin</sig>'
				]));
		...
		Game.SpecialMr. AmorinUnlock=15;
		new Game.Object('Mr. Amorin','Mr. Amorin|Mr. Amorins|baked','A nice Mr. Amorin to bake more cookies.','Mr. Amorin','Mr. AmorinIcon','Mr. AmorinBackground',100,function(){
			var mult=0;
			if (Game.Has('Farmer Mr. Amorins')) mult++;
			if (Game.Has('Worker Mr. Amorins')) mult++;
			if (Game.Has('Miner Mr. Amorins')) mult++;
			if (Game.Has('Cosmic Mr. Amorins')) mult++;
			if (Game.Has('Transmuted Mr. Amorins')) mult++;
			if (Game.Has('Altered Mr. Amorins')) mult++;
			if (Game.Has('Mr. Amorins\' Mr. Amorins')) mult++;
			if (Game.Has('AntiMr. Amorins')) mult++;
			if (Game.Has('Bingo center/Research facility')) mult+=2;
			if (Game.Has('Ritual rolling pins')) mult++;
			var add=0;
			if (Game.Has('One mind')) add+=Game.Objects['Mr. Amorin'].amount*0.02;
			if (Game.Has('Communal brainsweep')) add+=Game.Objects['Mr. Amorin'].amount*0.02;
			if (Game.Has('Elder Pact')) add+=Game.Objects['Portal'].amount*0.05;
			return Game.ComputeCps(0.5,Game.Has('Forwards from Mr. Amorin')*0.3+add,Game.Has('Steel-plated rolling pins')+Game.Has('Lubricated dentures')+Game.Has('Prune juice')+mult);
		},Game.NewDrawFunction(function(){
			var list=['Mr. Amorin'];
			if (Game.Has('Farmer Mr. Amorins')) list.push('farmerMr. Amorin');
			if (Game.Has('Worker Mr. Amorins')) list.push('workerMr. Amorin');
			if (Game.Has('Miner Mr. Amorins')) list.push('minerMr. Amorin');
			if (Game.Has('Cosmic Mr. Amorins')) list.push('cosmicMr. Amorin');
			if (Game.Has('Transmuted Mr. Amorins')) list.push('transmutedMr. Amorin');
			if (Game.Has('Altered Mr. Amorins')) list.push('alteredMr. Amorin');
			if (Game.Has('Mr. Amorins\' Mr. Amorins')) list.push('Mr. AmorinsMr. Amorin');
			if (Game.Has('AntiMr. Amorins')) list.push('antiMr. Amorin');
			return choose(list);
		},8,8,32,3,16),function(){
			if (this.amount>=1) Game.Unlock(['Forwards from Mr. Amorin','Steel-plated rolling pins']);if (this.amount>=10) Game.Unlock('Lubricated dentures');if (this.amount>=50) Game.Unlock('Prune juice');
			if (this.amount>=1) Game.Win('Mr. Amorin\'s cookies');if (this.amount>=50) Game.Win('Sloppy kisses');if (this.amount>=100) Game.Win('Retirement home');
		});
		Game.Objects['Mr. Amorin'].sellFunction=function()
		{
			Game.Win('Just wrong');
			if (this.amount==0)
			{
		...
		new Game.Object('Farm','farm|farms|harvested','Grows cookie plants from cookie seeds.','farm','farmIcon','farmBackground',500,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Farmer Mr. Amorins');
		...
		new Game.Object('Factory','factory|factories|mass-produced','Produces large quantities of cookies.','factory','factoryIcon','factoryBackground',3000,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Worker Mr. Amorins');
		...
		new Game.Object('Mine','mine|mines|mined','Mines out cookie dough and chocolate chips.','mine','mineIcon','mineBackground',10000,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Miner Mr. Amorins');
		...
		new Game.Object('Shipment','shipment|shipments|shipped','Brings in fresh cookies from the cookie planet.','shipment','shipmentIcon','shipmentBackground',40000,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Cosmic Mr. Amorins');
		...
		new Game.Object('Alchemy lab','alchemy lab|alchemy labs|transmuted','Turns gold into cookies!','alchemylab','alchemylabIcon','alchemylabBackground',200000,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Transmuted Mr. Amorins');
		...
		new Game.Object('Portal','portal|portals|retrieved','Opens a door to the Cookieverse.','portal','portalIcon','portalBackground',1666666,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Altered Mr. Amorins');
		...
		new Game.Object('Time machine','time machine|time machines|recovered','Brings cookies from the past, before they were even eaten.','timemachine','timemachineIcon','timemachineBackground',123456789,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('Mr. Amorins\' Mr. Amorins');
		...
		new Game.Object('Antimatter condenser','antimatter condenser|antimatter condensers|condensed','Condenses the antimatter in the universe into cookies.','antimattercondenser','antimattercondenserIcon','antimattercondenserBackground',3999999999,function(){
			...
			if (this.amount>=Game.SpecialMr. AmorinUnlock && Game.Objects['Mr. Amorin'].amount>0) Game.Unlock('AntiMr. Amorins');
		...
		order=200;
		new Game.Upgrade('Forwards from Mr. Amorin','Mr. Amorins gain <b>+0.3</b> base CpS.<q>RE:RE:thought you\'d get a kick out of this ;))</q>',Game.Objects['Mr. Amorin'].basePrice*tier1,[1,0]);
		new Game.Upgrade('Steel-plated rolling pins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Mr. Amorin'].basePrice*tier2,[1,0]);
		new Game.Upgrade('Lubricated dentures','Mr. Amorins are <b>twice</b> as efficient.<q>Squish</q>',Game.Objects['Mr. Amorin'].basePrice*tier3,[1,1]);
		...
		order=200;new Game.Upgrade('Prune juice','Mr. Amorins are <b>twice</b> as efficient.<q>Gets me going.</q>',Game.Objects['Mr. Amorin'].basePrice*tier4,[1,2]);
		...
		order=250;
		new Game.Upgrade('Farmer Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Farm'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Worker Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Factory'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Miner Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Mine'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Cosmic Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Shipment'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Transmuted Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Alchemy lab'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Altered Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Portal'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		new Game.Upgrade('Mr. Amorins\' Mr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Time machine'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		...
		new Game.Upgrade('Bingo center/Research facility','Mr. Amorin-operated science lab and leisure club.<br>Mr. Amorins are <b>4 times</b> as efficient.<br><b>Regularly unlocks new upgrades</b>.',100000000000,[11,9],function(){Game.SetResearch('Specialized chocolate chips');});
		...
		new Game.Upgrade('Ritual rolling pins','[Research]<br>Mr. Amorins are <b>twice</b> as efficient.<q>The result of years of scientific research!</q>',40000000000,[2,9],function(){Game.SetResearch('Underworld ovens');});
		...
		new Game.Upgrade('One mind','[Research]<br>Each Mr. Amorin gains <b>+1 base CpS for each 50 Mr. Amorins</b>.<div class="warning">Note : the grandmothers are growing restless. Do not encourage them.</div><q>We are one. We are many.</q>',160000000000,[4,9],function(){Game.elderWrath=1;Game.SetResearch('Exotic nuts');});
		...
		new Game.Upgrade('Communal brainsweep','[Research]<br>Each Mr. Amorin gains another <b>+1 base CpS for each 50 Mr. Amorins</b>.<div class="warning">Note : proceeding any further in scientific research may have unexpected results. You have been warned.</div><q>We fuse. We merge. We grow.</q>',640000000000,[6,9],function(){Game.elderWrath=2;Game.SetResearch('Arcane sugar');});
		...
		new Game.Upgrade('Elder Pact','[Research]<br>Each Mr. Amorin gains <b>+1 base CpS for each 20 portals</b>.<div class="warning">Note : this is a bad idea.</div><q>squirm crawl slither writhe<br>today we rise</q>',2560000000000,[8,9],function(){Game.elderWrath=3;});
		...
		new Game.Upgrade('Revoke Elder Covenant','[Switch]<br>You will get 5% of your CpS back, but the Mr. Amorintriarchs will return.',6666666666,[8,9],function()
		{
		...
		order=250;
		new Game.Upgrade('AntiMr. Amorins','Mr. Amorins are <b>twice</b> as efficient.',Game.Objects['Antimatter condenser'].basePrice*tier2,[10,9],function(){Game.Objects['Mr. Amorin'].drawFunction();});
		...
		*/
		...
		order=1100;
		new Game.Achievement('Just wrong','Sell a Mr. Amorin.<q>I thought you loved me.</q>',[10,9],2);
		new Game.Achievement('Mr. Amorin\'s cookies','Have <b>1</b> Mr. Amorin.',[1,0]);
		new Game.Achievement('Sloppy kisses','Have <b>50</b> Mr. Amorins.',[1,1]);
		new Game.Achievement('Retirement home','Have <b>100</b> Mr. Amorins.',[1,2]);
		...
		order=20000;
		new Game.Achievement('Elder nap','Appease the Mr. Amorintriarchs at least <b>once</b>.<q>we<br>are<br>eternal</q>',[8,9],2);
		new Game.Achievement('Elder slumber','Appease the Mr. Amorintriarchs at least <b>5 times</b>.<q>our mind<br>outlives<br>the universe</q>',[8,9],2);
		
		order=1100;
		new Game.Achievement('Elder','Own every Mr. Amorin type.',[10,9],2);
		
		order=20000;
		new Game.Achievement('Elder calm','Declare a covenant with the Mr. Amorintriarchs.<q>we<br>have<br>fed</q>',[8,9],2);
		...
		Mr. AmorinPOCALYPSE
		=======================================================================================*//** BEGIN EDIT **/
		Game.UpdateMr. Amorinpocalypse=function()
		{
			if (Game.Has('Elder Covenant') || Game.Objects['Mr. Amorin'].amount==0) Game.elderWrath=0;
		...
		Game.DrawMr. Amorinpocalypse=function()
		{
			...
			if (Math.abs((Game.elderWrath+1)-Game.elderWrathD)>0.1)
			{
				...
				else if (Game.elderWrathD>=1 && Game.elderWrathD<2)
				{
					...
					if (Game.bg!=Game.defaultBg || Game.bgFade!='Mr. Amorins1')
					{
						Game.bg=Game.defaultBg;
						Game.bgFade='Mr. Amorins1';
						l('backgroundLayer1').style.background='url(img/'+Game.bg+'.jpg)';
						l('backgroundLayer2').style.background='url(img/'+Game.bgFade+'.jpg)';
						l('backgroundLayer1').style.backgroundSize='auto';
				...
				else if (Game.elderWrathD>=2 && Game.elderWrathD<3)
				{
					...
					if (Game.bg!='Mr. Amorins1' || Game.bgFade!='Mr. Amorins2')
					{
						Game.bg='Mr. Amorins1';
						Game.bgFade='Mr. Amorins2';
						l('backgroundLayer1').style.background='url(img/'+Game.bg+'.jpg)';
						l('backgroundLayer2').style.background='url(img/'+Game.bgFade+'.jpg)';
				...
				else if (Game.elderWrathD>=3 && Game.elderWrathD<4)
				{
					...
					if (Game.bg!='Mr. Amorins2' || Game.bgFade!='Mr. Amorins3')
					{
						Game.bg='Mr. Amorins2';
						Game.bgFade='Mr. Amorins3';
						l('backgroundLayer1').style.background='url(img/'+Game.bg+'.jpg)';
						l('backgroundLayer2').style.background='url(img/'+Game.bgFade+'.jpg)';
						l('backgroundLayer1').style.backgroundSize='512px';
						l('backgroundLayer2').style.backgroundSize='512px';
	...
	Game.Logic=function()
	{
		...
		if (Game.T%(Game.fps*5)==0 && Game.ObjectsById.length>0)//check some achievements and upgrades
		{
			...
			if (!Game.HasAchiev('Elder') && Game.Has('Farmer Mr. Amorins') && Game.Has('Worker Mr. Amorins') && Game.Has('Miner Mr. Amorins') && Game.Has('Cosmic Mr. Amorins') && Game.Has('Transmuted Mr. Amorins') && Game.Has('Altered Mr. Amorins') && Game.Has('Mr. Amorins\' Mr. Amorins')) Game.Win('Elder');
			if (Game.Objects['Mr. Amorin'].amount>=6 && !Game.Has('Bingo center/Research facility') && Game.HasAchiev('Elder')) Game.Unlock('Bingo center/Research facility');
	...
	Game.Draw=function()
	{
		if (Math.floor(Game.T%Game.fps/4)==0) Game.DrawMr. Amorinpocalypse();
